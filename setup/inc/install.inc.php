...
{
    return $msg != NULL ? "class='error alert alert-danger' <strong> <i class='bi
    bi-exclamation-circle-fill'></i><text>{$msg}</text></strong>" : '';
}
...
<div id="main" class="step2">
    ...
    <div <?php echo __(show_alert($errors['err'])) ?>
    </div>
    <form action="install.php" method="post" id="install">
        ...
        <div>
            <div class="form-floating">
                ...
                <div <?php echo __(show_alert($errors['name'])) ?>
                </div>
            </div>
        </div>
        <div>
            <div class="form-floating">
                ...
                <div <?php echo __(show_alert($errors['email'])) ?>
                </div>
            </div>
            <div>
                <div class="form-floating">
            ...
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['fname'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['lname'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['admin_email'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['username'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['passwd'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['passwd2'])) ?>
                    </div>
                </div>
            </div>
            ...
            <span class="subhead">
                ...
                <div <?php echo __(show_alert($errors['db'])) ?>
                </div>
            </span>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['prefix'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['dbhost'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['dbname'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['dbuser'])) ?>
                    </div>
                </div>
            </div>
            <div>
                <div class="form-floating">
                    ...
                    <div <?php echo __(show_alert($errors['dbpass'])) ?>
                    </div>
                </div>
            </div>
            <br>
