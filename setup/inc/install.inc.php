...
<div id="main" class="step2">
    ...
    <form action="install.php" method="post" id="install">
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="name" size="45" tabindex="1"
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="email" size="45" tabindex="2"
        ...
        <div class="row">
            ...
            <select class="form-select" name="lang_id">
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="fname" size="45" tabindex="3"
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="lname" size="45" tabindex="4"
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="username" size="45" tabindex="6"
                value="<?php echo $info['username']; ?>" autocomplete="off">
        ...
        <div class="row">
            ...
            <input class="form-control" type="password" name="passwd" size="45" tabindex="7"
                value="<?php echo $info['passwd']; ?>" autocomplete="off">
        ...
        <div class="row">
            ...
            <input class="form-control" type="password" name="passwd2" size="45" tabindex="8"
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="prefix" size="45" tabindex="9"
                value="<?php echo $info['prefix']; ?>">
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="dbhost" size="45" tabindex="10"
                value="<?php echo $info['dbhost']; ?>">
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="dbname" size="45" tabindex="11"
                value="<?php echo $info['dbname']; ?>">
        ...
        <div class="row">
            ...
            <input class="form-control" type="text" name="dbuser" size="45" tabindex="12"
                value="<?php echo $info['dbuser']; ?>">
        ...
        <div class="row">
            ...
            <input class="form-control" type="password" name="dbpass" size="45" tabindex="13"
                value="<?php echo $info['dbpass']; ?>">
