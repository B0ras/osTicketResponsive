...
<form action="apikeys.php?<?php echo Http::build_query($qs); ?>" method="post" class="save">
        ...
        <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="radio" name="isactive" value="1" <?php echo $info['isactive'] ? 'checked="checked"' : ''; ?>><strong>
                            <?php echo __('Active'); ?>
                        </strong>
                ...
                <tr>
                    <th colspan="2">
                        <em><strong><?php echo __('Services'); ?>:</strong>
                            <?php echo __('Check applicable API services enabled for the key.'); ?>
                        </em>
                    </th>
                </tr>
                <tr>
                ...
                <tr>
                    <th colspan="2">
                        <em><strong>
                            ...
                            </strong>: <?php echo __("Be liberal, they're internal"); ?></em>
                    </th>
                </tr>
                <tr>
                    <td colspan=2>
    ...
    <p style="text-align:center">
        ...
        <input type="button" name="cancel" value="<?php echo __('Cancel'); ?>"
            onclick='window.location.href="apikeys.php"'>
    </p>
</form>