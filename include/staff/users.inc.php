    ...
    <div style="min-height:25px;">
        <form action="users.php" method="get">
            ...
            <div class="attached input">
                <input type="text" class="basic-search" id="basic-user-search" name="query" size="30"
            ...
            <tbody>
                ...
                foreach ($users as $U) {
                    ...
                    <tr id="<?php echo $U['id']; ?>">
                        ...
                        <td>&nbsp;
                            <a class="preview" href="users.php?id=<?php echo $U['id']; ?>"
                                data-preview="#users/<?php echo $U['id']; ?>/preview">
                                <?php
