...
<form action="settings.php?t=pages" method="post" class="save" enctype="multipart/form-data">
    <?php csrf_token(); ?>
    ...
    <div class="tab_content table-responsive" id="basic-information">
    ...
    <div class="hidden tab_content table-responsive" id="site-pages">
        <table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
            <thead>
                <tr>
                    <th colspan="2">
            ...
            <tbody>
                        ...
                        <span>
                            <select name="landing_page_id">
                                ...
                                foreach ($pages as $page) {
                                    if (strcasecmp($page->getType(), 'landing'))
                                        continue;
                                    echo sprintf(
                            ...
                            </select>&nbsp;<font class="error">
                                <?php echo $errors['landing_page_id']; ?>
                            </font>
                    ...
                    <td>
                        <span>
                            <select name="offline_page_id">
                                ...
                                <?php
                                foreach ($pages as $page) {
                                    if (strcasecmp($page->getType(), 'offline'))
                                        continue;
                                    echo sprintf(
                                        '<option value="%d" %s>%s</option>',
                                        $page->getId(),
                                ...
                                <?php echo $errors['offline_page_id']; ?>
                            </font>
                ...
                <tr>
                    <td width="220" class="required">
                        <?php
                        echo __('Default Thank-You Page'); ?>:
                    </td>
                    <td>
                        <span>
                            <select name="thank-you_page_id">
                                ...
                                <?php echo $errors['thank-you_page_id']; ?>
                            </font>
    ...
    <div class="hidden tab_content table-responsive" id="logos">
        <table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
            <thead>
                <tr>
                    <th colspan="2">
                        <em>
                            <?php echo __('System Default Logo'); ?><i class="help-tip icon-question-sign"
                                href="#logos"></i>
                        </em>
                    </th>
                </tr>
                    ...
                    <td colspan="2">
                        <table style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="radio" name="selected-logo" value="0" style="margin-left: 1em"
                                            <?php if (!$ost->getConfig()->getClientLogoId())
                                            echo 'checked="checked"'; ?> />
                                    </td>
                                    <td>
                                        <input type="radio" name="selected-logo-scp" value="0" style="margin-left: 1em"
                                            <?php if (!$ost->getConfig()->getStaffLogoId())
                                            echo 'checked="checked"'; ?>/>
                                    </td>
                                    <td>
                                        <img src="<?php echo ROOT_PATH; ?>assets/default/images/logo.png"
                                            alt="Default Logo" valign="middle" style="box-shadow: 0 0 0.5em rgba(0,0,0,0.5);
                                            margin: 0.5em; height: 5em;
                                            vertical-align: middle" />
                                        <img src="<?php echo ROOT_PATH; ?>scp/images/ost-logo.png" alt="Default Logo"
                                ...
                                <tr>
                                    <th colspan="3">
                                        <em>
                                            <?php echo __('Use a custom logo'); ?>&nbsp;<i
                                                class="help-tip icon-question-sign" href="#upload_a_new_logo"></i>
                                        </em>
                                    </th>
                                </tr>
                                <?php
                                ...
                                foreach (AttachmentFile::allLogos() as $logo) { ?>
                                    <tr>
                                        <td>
                                            <input type="radio" name="selected-logo" style="margin-left: 1em" value="<?php
                                            echo $logo->getId(); ?>" <?php
                                              if ($logo->getId() == $current)
                                                  echo 'checked="checked"'; ?> />
                                        </td>
                                        <td>
                                            <input type="radio" name="selected-logo-scp" style="margin-left: 1em" value="<?php
                                            echo $logo->getId(); ?>" <?php
    ...
    <div class="hidden tab_content table-responsive" id="backdrops">
        <table class="form_table settings_table" width="940" border="0" cellspacing="0" cellpadding="2">
            <thead>
                <tr>
                    <th colspan="2">
                        <em>
                            <?php echo __('System Default Backdrop'); ?><i class="help-tip icon-question-sign"
                                href="#backdrops"></i>
                        </em>
                    </th>
                </tr>
                    ...
                    <td colspan="2">
                        <table style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="radio" name="selected-backdrop" value="0" style="margin-left: 1em"
                                            <?php if (!$ost->getConfig()->getStaffLogoId())
                                            echo 'checked="checked"'; ?>/>
                                    </td>
                                    <td>
                                        <img src="<?php echo ROOT_PATH; ?>scp/images/login-headquarters.jpg"
                                            alt="Default Backdrop" valign="middle" style="box-shadow: 0 0 0.5em rgba(0,0,0,0.5);
                                ...
                                foreach (AttachmentFile::allBackdrops() as $logo) { ?>
                                    <tr>
                                        <td>
                                            <input type="radio" name="selected-backdrop" style="margin-left: 1em" value="<?php
                                            echo $logo->getId(); ?>" <?php
                                              if ($logo->getId() == $current)
                                                  echo 'checked="checked"'; ?> />
                                        </td>
                                        <td>
                                            <img src="<?php echo $logo->getDownloadUrl(); ?>" alt="Custom Backdrop"
                                                valign="middle" style="box-shadow: 0 0 0.5em rgba(0,0,0,0.5);
                                                                margin: 0.5em; height: 6em;
                                                                vertical-align: middle;" />
