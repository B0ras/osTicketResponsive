...
if (!isset($_SERVER['HTTP_X_PJAX'])) { ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo ROOT_PATH ?>scp/css/scp_responsive.css" media="all">
    ...
    <body>
        <div id="container" class="">
            ...
            <div id="header" class="row">
                ...
                <a href="<?php echo ROOT_PATH ?>scp/index.php" class="no-pjax order-1 col-12 col-md-6" id="logo">
            ...
            <div id="pjax-container" class="row <?php if ($_POST)
            echo 'no-pjax'; ?>">
                <?php } else {
    ...
    if ($pjax = $ost->getExtraPjax()) { ?>
                    ...
                    <?php }foreach ($ost->getExtraHeaders() as $h) {
        if (strpos($h, '<script ') !== false)
            ...
            <div id="content">
                <?php if (isset($errors['err'])) { ?>
                    ...
                    <div class="<?php echo strtolower($M->getLevel()); ?>-banner">
                        <?php
                        echo (string) $M; ?>
                    </div>
                    <?php } ?>