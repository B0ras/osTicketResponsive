...
<p class="text-center">
    <input class="btn orange-button small-margin-top" type="submit" name="submit" value="<?php echo __('Save Changes');?>">
    <input class="btn btn-outline-warning small-margin-top" type="reset" name="reset" value="<?php echo __('Reset Changes');?>">
</p>
</form>
<script type="text/javascript">
$(function() {
