                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="error">
                                <?php echo Format::htmlchars($errors['client_avatar']); ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <?php echo __('Registration Method'); ?>:
                        </td>
                        <td><select name="client_registration">
                                <?php foreach (array('disabled' => __('Disabled — All users are guests'), 'public' => __('Public — Anyone can register'), 'closed' => __('Private — Only agents can register users'), ) as $key => $val) { ?>
                    ...
                    <tr>
                        <td>
                            <?php echo __('User Excessive Logins'); ?>:
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <?php echo __('User Session Timeout'); ?>:
                        </td>
                        <td>
                            <input type="text" name="client_session_timeout" size=6
                                value="<?php echo $config['client_session_timeout']; ?>">
                    ...
                    <tr>
                        <td>
                            <?php echo __('Client Quick Access'); ?>:
                        </td>
