<div class="row">
  <h3 class="col-8">
    <?php echo __('Ticket Queues'); ?>
  </h3>
  <div class="pull-right col d-flex">
    <a href="queues.php?t=tickets&amp;a=add" class="btn btn-outline-secondary small-margin-right"
      style="height:fit-content">
      <i class="icon-plus-sign"></i>
      <?php echo __('Add New Queue'); ?>
    </a>
    <!-- TO DO: Elements do not work -->
    <div class="dropdown" data-dropdown="#action-dropdown-more">
      ...
      foreach ($queues as $q) { ?>
        <tr>
          ...
          <td>
            ...
            <input type="hidden" name="qsort[<?php echo $q->id; ?>]" value="<?php echo $q->sort; ?>" />
          </td>
          ...
          <td>
            <?php echo Format::htmlchars($q->staff ? $q->staff->getName() :
              __('SYSTEM')); ?>
          </td>
          <td>
            <?php echo Format::htmlchars($q->getStatus()); ?>
          </td>
          <td>
            <?php echo Format::date($q->created); ?>
          </td>
        </tr>
        <?php
