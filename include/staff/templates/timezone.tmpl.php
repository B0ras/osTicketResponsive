...
?>
<select class="form-select" name="<?php echo $TZ_NAME; ?>" id="timezone-dropdown"
...
<button type="button" class="action-button btn btn-secondary" onclick="javascript:
...
return false;" style="vertical-align:middle"><i class="icon-map-marker"></i>
    <?php echo __('Auto Detect'); ?>
</button>
