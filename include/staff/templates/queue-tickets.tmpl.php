    ...
    <div class="sticky bar opaque">
        <div class="content">
            <div class="pull-left flush-left">
                <h2><a href="<?php echo $refresh_url; ?>" title="<?php echo __('Refresh'); ?>"><i
...
<form action="?" method="POST" name='tickets' id="tickets">
    ...
    <div class="table-responsive">
        ...
        <table class="list queue tickets table" border="0" cellspacing="1" cellpadding="2">
            <thead>
                <tr>
                    <?php
