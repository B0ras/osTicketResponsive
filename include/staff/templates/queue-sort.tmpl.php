...
<div class="dropdown small-margin-left">
...
<span class="action-button muted" data-dropdown="#sort-dropdown" data-toggle="tooltip" title="<?php
if (is_object($queuesort))
  echo Format::htmlchars($queuesort->getName()); ?>">
