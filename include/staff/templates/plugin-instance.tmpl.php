...
<ul class="clean tabs" id="instance-tabs">
    <li class="<?php
    if (!$instance)
        echo 'active '; ?> "><a href="#instance">
            <i class="icon-info-sign"></i>
            <?php echo __('Instance'); ?>
        </a></li>
    <li <?php if ($instance)
        echo 'class="active"'; ?>><a href="#config">
            <i class="icon-cog"></i>
            <?php echo __('Config'); ?>
        </a></li>
</ul>
<div id="instance-tabs_container">
    <div id="instance" class="tab_content <?php if ($instance)
        echo 'hidden'; ?>">
        <table class="form_table" width="100%" border="0" cellspacing="0" cellpadding="2">
            <thead>
                <tr>
                    <th colspan="2">
                        <em>
                            <?php echo __('Instance Name and Status'); ?>
                        </em>
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>
                        <input size="50" type="text" name="name" value="<?php echo $info['name']; ?>" /><br />
                        <span class="error">
                ...
                <tr>
                    <th colspan="7">
                        <em><strong>
                            ...
                            <?php echo __("Instance description and notes"); ?>
                        </em>
                    </th>
                </tr>
                <tr>
    ...
    <div id="config" class="tab_content <?php if (!$instance)
        echo 'hidden'; ?>" style="padding: 0 2px 0 2px;">
        <?php
