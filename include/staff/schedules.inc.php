<form action="schedules.php" method="POST" name="schedules">
    ...
    <div class="sticky bar opaque">
        <div class="content">
            <div class="pull-left flush-left">
                <h2>
                    <?php echo __('Schedules'); ?>
                </h2>
            </div>
            <div class="pull-right flush-right">
                <a class="green button action-button" id="new-schedule" href="#schedule/add">
    ...
    <div class="table-responsive">
        <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
            ...
            <tbody>
                <?php foreach (Schedule::objects()->order_by('name')->limit($pageNav->getLimit())->offset($pageNav->getStart()) as $schedule) {
                    $sel = false;
                    ...
                    <tr>
                        <td align="center">
                            <input width="7" type="checkbox" class="ckb" name="ids[]"
                                value="<?php echo $schedule->getId(); ?>" <?php echo $sel ? 'checked="checked"' : ''; ?>>
                        </td>
                        <td><a href="?id=<?php echo $schedule->getId(); ?>">
                                <?php echo
                                    $schedule->getName(); ?>
                            </a><span class="pull-right"><small class="faded-more"><i class="icon-calendar"></i>
                                    <?php
                                    echo $schedule->getNumEntries(); ?>
                                </small></span>
                        </td>
                        <td><?php echo Format::htmlchars($schedule->getTypeDesc()); ?></td>
                        <td>
                            <?php echo Format::date($schedule->getCreated()); ?>
                        </td>
