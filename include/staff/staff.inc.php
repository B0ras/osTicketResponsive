    ...
    <table class="table two-column" width="940" border="0" cellspacing="0" cellpadding="2">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input type="text" size="40" style="width:300px" class="staff-username typeahead" name="username"
        ...
        if (($bks = StaffAuthenticationBackend::getInteractive())) {
          ...
          <tr>
            <td>
              <?php echo __('Authentication Backend'); ?>:
            </td>
            <td>
        ...
        if ($bks = Staff2FABackend::allRegistered() && $current = $staff->get2FABackend()) {
          ...
          <tr>
            ...
            <td>
              <input type="text" size="40" style="width:300px" name="default_2fa" disabled
        ...
        <tr>
          <td colspan="2">
            ...
            <label class="checkbox">
              <input type="checkbox" name="islocked" value="1" <?php echo (!$staff->isactive) ? 'checked="checked"' : ''; ?> />
              <?php echo __('Locked'); ?>
            </label>
            <label class="checkbox">
              <input type="checkbox" name="isadmin" value="1" <?php echo ($staff->isadmin) ? 'checked="checked"' : ''; ?> />
              <?php echo __('Administrator'); ?>
            </label>
            <label class="checkbox">
              <input type="checkbox" name="assigned_only" <?php echo ($staff->assigned_only) ? 'checked="checked"' : ''; ?> />
        ...
        <tr>
          ...
          <td>
            <label class="inline checkbox">
              ...
              <i class="icon-question-sign help-tip" href="#primary_role_on_assign"></i>
            </label>
          </td>
        </tr>
      </tbody>
            ...
            <tr>
              <td>
                <label>
                  <?php
                  echo sprintf(
                    '<input type="checkbox" name="perms[]" value="%s" %s />',
