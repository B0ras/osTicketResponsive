<form action="lists.php" method="POST" name="lists">
    ...
    <div class="table-responsive">
        <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
            ...
            <tbody>
                <?php foreach (DynamicList::objects()->order_by('-type', 'name')->limit($pageNav->getLimit())->offset($pageNav->getStart()) as $list) {
                    $sel = false;
                    ...
                    <tr>
                        ...
                        <td><a href="?id=<?php echo $list->getId(); ?>">
                                <?php echo
                                    $list->getPluralName() ?: $list->getName(); ?>
                            </a></td>
                        <td>
                            <?php echo $list->get('created'); ?>
                        </td>
