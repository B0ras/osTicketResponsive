...
<form method="post" action="dashboard.php">
  <div id="basic_search">
    <div style="min-height:25px;">
      ...
      <label>
        ...
        <input type="text" class="dp input-medium search-query" name="start"
          placeholder="<?php echo __('Last month'); ?>" value="<?php
  ...
  <div style="position:relative">
    <div id="line-chart-here" class="table-responsive"></div>
  ...
  foreach ($groups as $g => $desc) {
    ...
    <div class="tab_content table-responsive <?php echo (!$first) ? 'hidden' : ''; ?>"
