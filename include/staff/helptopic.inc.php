...
<form action="helptopics.php?<?php echo Http::build_query($qs); ?>" method="post" class="save">
    ...
    <div id="topic-tabs_container">
        <div class="tab_content table-responsive" id="info">
            <table class="table" border="0" cellspacing="0" cellpadding="2">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="ispublic" value="1" <?php echo $info['ispublic'] ? 'checked="checked"' : ''; ?>>
                            <?php echo __('Public'); ?>
                            <input type="radio" name="ispublic" value="0" <?php echo !$info['ispublic'] ? 'checked="checked"' : ''; ?>>
                            <?php echo __('Private/Internal'); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="topic_pid">
                                <option value="">&mdash; <?php echo __('Top-Level Topic'); ?> &mdash;</option>
                                <?php
                                $topics = Topic::getHelpTopics();
                                foreach ($topics as $id => $topic) {
                                    if ($id == $info['topic_id'])
                                        continue; ?>
                                    <option value="<?php echo $id; ?>" <?php echo ($info['topic_pid'] == $id) ? 'selected' : ''; ?>>
                                        <?php echo $topic; ?>
                                    </option>
                                    <?php
                                } ?>
            ...
            <textarea class="richtext no-bar" name="notes" cols="21" rows="8"
                style="width: 80%;"><?php echo $info['notes']; ?></textarea>
        ...
        <div class="hidden tab_content" id="routing">
            <div style="padding:8px 0;border-bottom: 2px dotted #ddd;">
                <div><b class="big">
                        <?php echo __('New ticket options'); ?>
                    </b></div>
            </div>
                        ...
                        <td>
                            <label>
                                ...
                                <input type="radio" name="custom-numbers" value="1" <?php echo $info['custom-numbers'] ? 'checked="checked"' : ''; ?>
                                    onchange="javascript:$('#custom-numbers').show(200);">
                                <?php echo __('Custom'); ?>
                ...
                echo 'display:none'; ?>">
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="faded">
                                <?php echo __('e.g.'); ?> <span id="format-example"><?php
                                ...
                                if ($slas = SLA::getSLAs()) {
                                    foreach ($slas as $id => $name) {
                                        echo sprintf(
                                            ...
                                            $id, ($info['sla_id'] == $id) ? 'selected="selected"' : '',
                                            $name
                                        );
                                    }
                                }
                        ...
                        <td>
                            <select name="assign" data-quick-add>
                                ...
                                if ($teams = Team::getTeams()) { ?>
                                    ...
                                    echo sprintf(__('Teams (%d)'), count($teams)); ?>">
                                        <?php
        ...
        <div class="hidden tab_content" id="forms">
                ...
                foreach ($forms as $F) {
                    ...
                    <tbody data-form-id="<?php echo $F->get('id'); ?>">
                        ...
                        return false;"><i class="icon-large icon-trash"></i></a>
                                ...
                                <div>
                                    <?php echo Format::display($F->getLocal('instructions')); ?>
                                </div>
                            </td>
                        </tr>
            ...
            <br />
            <strong>
                <?php echo __('Add Custom Form'); ?>
            </strong>:
            <select name="form_id" id="newform">
                <option value="">
                    <?php echo '— ' . __('Add a custom form') . ' —'; ?>
                </option>
                <?php foreach (DynamicForm::objects()->filter(array('type' => 'G'))->exclude(array('flags__hasbit' => DynamicForm::FLAG_DELETED)) as $F) { ?>
