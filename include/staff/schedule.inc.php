...
<div class="pull-right flush-right">
    ...
    <div id="schedule-dropdown-more" class="action-dropdown anchor-right">
        <ul id="schedule-actions">
            <li><a class="schedule-action" href="#schedule/<?php echo $schedule->getId(); ?>/clone">
                    <i class="icon-copy icon-fixed-width"></i>
                    <?php echo __('Clone'); ?>
                </a></li>
            <?php
            if ($schedule->isBusinessHours()) { ?>
                <li><a class="schedule-action" href="#schedule/<?php echo $schedule->getId(); ?>/diagnostic">
                        <i class="icon-eye-open icon-fixed-width"></i>
                        <?php echo __('Diagnostic'); ?>
                    </a></li>
            <?php
            } ?>
        </ul>
...
<form action="" method="post" class="save">
    ...
    <div id="schedule-tabs_container">
        <div id="schedule" class="tab_content hidden table-responsive">
            <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
                <thead>
                    <tr>
                        <th colspan="2">
                            <em>
                                <?php echo __('Schedule Details'); ?><i class="help-tip icon-question-sign"
                                    href="#schedule"></i>
                            </em>
                        </th>
                    </tr>
