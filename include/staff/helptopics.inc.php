    ...
    <div class="sticky bar opaque">
        <div class="content">
            ...
            <div class="pull-right flush-right d-flex">
                ...
                <?php } ?>
                <a href="helptopics.php?a=add" class="btn btn-sm btn-outline-secondary small-margin-right"><i
                        class="icon-plus-sign"></i>
                    <?php echo __('Add New Help Topic'); ?>
                </a>
                <div class="dropdown">
        ...
        <div class="table-responsive">
            <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
                ...
                <thead>
                    <tr>
                        <td colspan="7">
                            <div style="padding:3px" class="pull-right">
                                <?php echo __('Sorting Mode'); ?>:
...
">
                                    <?php foreach (OsticketConfig::allTopicSortModes() as $i => $m)
                                        echo sprintf(
                                            ...
                                            $i, $i == $cfg->getTopicSortMode() ? ' selected="selected"' : '',
                                            $m
                                        ); ?>
                                </select>
                            </div>
                    ...
                    <tr>
                        ...
                        <th style="padding-left:4px;vertical-align:middle" width="26%">
                            <?php echo __('Help Topic'); ?>
                        </th>
                        <th style="padding-left:4px;vertical-align:middle" width="8%">
                            <?php echo __('Status'); ?>
                        </th>
                        <th style="padding-left:4px;vertical-align:middle" width="8%">
                            <?php echo __('Type'); ?>
                        </th>
                        <th style="padding-left:4px;vertical-align:middle" width="10%">
                            <?php echo __('Priority'); ?>
                        </th>
                        <th style="padding-left:4px;vertical-align:middle" width="14%">
                            <?php echo __('Department'); ?>
                        </th>
                        <th style="padding-left:4px;vertical-align:middle" width="15%" nowrap>
                ...
                <tbody class="<?php if ($cfg->getTopicSortMode() == 'm')
                    echo 'sortable-rows'; ?>" data-sort="sort-">
                    <?php
                        ...
                        foreach ($names as $topic_id => $name) {
                            ...
                            <tr id="<?php echo $id; ?>">
                                <td align="center">
                                    ...
                                    <input type="checkbox" class="ckb" name="ids[]" value="<?php echo $id; ?>" <?php
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <a href="helptopics.php?id=<?php echo $id; ?>">
                                        <?php
                                        echo Topic::getTopicName($id); ?>
                                    </a>&nbsp;
                                </td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <?php echo $topic->ispublic ? __('Public') : '<b>' . __('Private') . '</b>'; ?>
                                </td>
                                <td>
                                    <?php echo $priority; ?>
                                </td>
                                ...
                                <td>&nbsp;
                                    <?php echo Format::datetime($topic->updated); ?>
                                </td>
                                <td>&nbsp;
                                    <?php echo Format::datetime($topic->created); ?>
                                </td>
                            </tr>
                            <?php
                        } //end of foreach.
