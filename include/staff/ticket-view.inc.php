...
<div>
    ...
    <div class="sticky bar">
       <div class="content">
        <div class="pull-right flush-right btn-group">
            <?php
            if (
                ...
                || ($dept && $dept->isManager($thisstaff))
                                                                        ...
                                                                        <span class="action-button pull-right btn btn-sm btn-outline-secondary" data-placement="bottom" data-dropdown="#action-dropdown-more" data-toggle="tooltip" title="<?php echo __('More'); ?>">
            ...
            if ($role->hasPerm(Ticket::PERM_EDIT)) { ?>
                                                                            <a class="action-button pull-right btn btn-sm btn-outline-secondary" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Edit'); ?>" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=edit"><i class="icon-edit"></i></a>
                        <?php
            } ?>
            <span class="action-button pull-right btn btn btn-sm btn-outline-secondary" data-placement="bottom" data-dropdown="#action-dropdown-print" data-toggle="tooltip" title="<?php echo __('Print'); ?>">
                <i class="icon-caret-down pull-right"></i>
            ...
            if ($role->hasPerm(Ticket::PERM_TRANSFER)) { ?>
                                                                        <a class="action-button pull-right ticket-action btn btn-sm btn-outline-secondary" id="ticket-transfer" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Transfer'); ?>"
            ...
            if ($ticket->isOpen() && $role->hasPerm(Ticket::PERM_ASSIGN)) { ?>
                                                                        <span class="action-button pull-right btn btn-sm btn-outline-secondary"
            ...
            <div id="action-dropdown-more" class="action-dropdown anchor-right btn btn-sm btn-outline-secondary">
              <ul>
                <?php
                if ($role->hasPerm(Ticket::PERM_EDIT)) { ?>
...
?>
                ...
                if ($role->hasPerm(Ticket::PERM_REPLY)) { ?>
                                                                            <a href="#post-reply" class=" action-button btn btn-sm btn-outline-secondary"
                                                                            data-placement="bottom" data-toggle="tooltip"
                                                                            title="<?php echo __('Post Reply'); ?>"><i class="icon-mail-reply"></i></a>
                            <?php
                } ?>
                <a href="#post-note" id="post-note" class="action-button btn btn-sm btn-outline-secondary"
                data-placement="bottom" data-toggle="tooltip"
            ...
            <table border="0" cellspacing="0" cellpadding="4" width="100%">
                <tr>
                    ...
                    <td><a href="#tickets/<?php echo $ticket->getId(); ?>/user"
                        ...
                        <?php
                        if ($user) { ?>
                                                                                        <a href="tickets.php?<?php echo Http::build_query(
                                                                                            array(
                                                                                                'status' => 'open',
                                                                                                'a' => 'search',
                                                                                                'uid' => $user->getId()
...
<?php if ($user->getOrganization()) { ?>
                                                            ...
                                                            <?php if ($open = $user->getNumOpenOrganizationTickets()) { ?>
                                                                                                                                                            <li><a href="tickets.php?<?php echo Http::build_query(
                                                                                                                                                                array(
                                                                                                                                                                    'a' => 'search',
                                                                                                                                                                    'status' => 'open',
                                                                                                                                                                    'orgid' => $user->getOrgId()
...
foreach (DynamicFormEntry::forTicket($ticket->getId()) as $form) {
    ...
    //           array('email', ...))));
    $answers = $form->getAnswers()->exclude(
        Q::any(
            array(
        ...
        ?>
                                ...
                                ------------- ' . __('Premade Replies') . ' ------------- </option>';
                                                                    ...
                                                                    <p  style="text-align:center;">
                                                                        <button class="btn btn-sm orange-button" type="submit">
