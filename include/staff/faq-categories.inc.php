...
<form id="kbSearch" action="kb.php" method="get">
    ...
    <div id="basic_search">
        <div class="input-group">
            <input class="form-control form-control-sm" id="query" type="text" size="20" name="q" autofocus
                value="<?php echo Format::htmlchars($_REQUEST['q']); ?>">
            <button class="btn btn-sm btn-outline-secondary" id="searchSubmit" type="submit">
        ...
        <!-- <div id="category-dropdown" class="action-dropdown anchor-right" onclick="javascript:
                var form = $(this).closest('form');
                form.find('[name=cid]').val($(event.target).data('cid'));
                form.submit();">
            <ul class="bleed-left">
        ...
        <!-- <div id="topic-dropdown" class="action-dropdown anchor-right" onclick="javascript:
                var form = $(this).closest('form');
