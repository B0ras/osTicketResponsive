...
}class UserNav
{
    ...
    function getNavLinks()
    {
        ...
        if (!$this->navs) {
            ...
            $navs = array();
            $user = $this->user;
            $navs['home'] = array('desc' => __('Support Center Home'), 'href' => 'index.php', 'title' => '', 'icon' => "icon-home");
            if ($cfg && $cfg->isKnowledgebaseEnabled())
                $navs['kb'] = array('desc' => __('Knowledgebase'), 'href' => 'kb/index.php', 'title' => '', 'icon' => "icon-home");
            ...
            if (
                ...
                $navs['new'] = array('desc' => __('Open a New Ticket'), 'href' => 'open.php', 'title' => '', 'icon' => "icon-file");
            if ($user && $user->isValid()) {
                ...
                $navs['status'] = array('desc' => __('Check Ticket Status'), 'href' => 'view.php', 'title' => '', 'icon' => "icon-flag");
            }
            $this->navs = $navs;
        }
