...
<form action="login.php" method="post" id="clientLogin">
    <?php csrf_token(); ?>
    <div class="row">
        <div class="login-box col-sm-6 col-12">
            <div><strong>
            ...
            <div>
                <label for="email">
                    ...
                    <input id="email" placeholder="<?php echo __('e.g. john.doe@osticket.com'); ?>" type="text"
                        name="lemail" size="30" value="<?php echo $email; ?>" class="nowarn form-control-sm">
                </label>
            </div>
            <div>
                <label for="ticketno">
                    ...
                    <input id="ticketno" type="text" name="lticket" placeholder="<?php echo __('e.g. 051243'); ?>"
                        size="30" value="<?php echo $ticketid; ?>" class="nowarn form-control-sm">
                </label>
            </div>
            <div>
                <button class="btn btn-outline-orange" type="submit" value="">
                    <?php echo $button; ?>
                </button>
            </div>

        </div>
        <div class="instructions col-sm-6 col-12">
