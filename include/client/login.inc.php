...
<form action="login.php" method="post" id="clientLogin">
    ...
    <div style="display:table-row">
        <div class="login-box">
            ...
            <div>
                <input id="username" placeholder="<?php echo __('Email or Username'); ?>" type="text" name="luser"
                    size="30" value="<?php echo $email; ?>" class="nowarn form-control">
            </div>
            <div>
                <input id="passwd" placeholder="<?php echo __('Password'); ?>" type="password" name="lpasswd" size="30"
                    value="<?php echo $passwd; ?>" class="nowarn form-control"></td>
            </div>
            <p>
                <input class="btn btn-outline-orange" type="submit" value="<?php echo __('Sign In'); ?>">
                <?php if ($suggest_pwreset) { ?>
                    <a style="padding-top:4px;display:inline-block;" href="pwreset.php">
