...
<form action="emailtest.php" method="post" class="save">
    ...
    <h2>
        <?php echo __('Test Outgoing Email'); ?>
    </h2>
        ...
        <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
            <thead>
                <tr>
                    <th colspan="2">
                        <em>
                            <?php echo __('Use the following form to test whether your <strong>Outgoing Email</strong> settings are properly established.');
            ...
            <tbody>
                    ...
                    <td>
                        <select name="email_id">
                            <option value="0">&mdash;
                                <?php echo __('Select FROM Email'); ?> &mdash;
                            </option>
                            <?php
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="60" name="email" value="<?php echo $info['email']; ?>" autofocus>
                        &nbsp;<span class="error">
                    ...
                    <td colspan=2>
                        <div style="padding-top:0.5em;padding-bottom:0.5em">
                            <em><strong>
                                ...
                                <?php echo __('email message to send.'); ?>
                            </em>&nbsp;<span class="error">
                                <?php echo $errors['message']; ?>
                            </span>
                        </div>
                        <textarea class="richtext draft draft-delete" name="body" cols="21" rows="10"
                            style="width: 90%;" <?php
    ...
    <p class="text-center">
        <input class="btn btn-sm orange-button small-margin-top" type="submit" name="submit"
            value="<?php echo __('Send Message'); ?>">
        <input class="btn btn-sm btn-outline-warning small-margin-top" type="reset" name="reset"
            value="<?php echo __('Reset'); ?>">
        <input class="btn btn-sm btn-outline-danger small-margin-top" type="button" name="cancel"
            value="<?php echo __('Cancel'); ?>" onclick='window.location.href="emails.php"'>
    </p>
</form>
<?php
